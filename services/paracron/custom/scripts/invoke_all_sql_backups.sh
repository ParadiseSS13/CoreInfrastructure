...
# Game DB
backup_mysql.sh --host 172.28.0.14 --user backup_user --password ${MYSQL_BACKUP_PW} --dbname paradise_gamedb --backuppath /data/mysql_backups/gamedb
# PR DB
...
# TGS DB
backup_mysql.sh --host 172.28.0.14 --user backup_user --password ${MYSQL_BACKUP_PW} --dbname paradise_tgs_espresso3 --backuppath /data/mysql_backups/tgs
# Wiki DB
